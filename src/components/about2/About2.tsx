				...
				<div className="row">
					<div className="embed-responsive embed-responsive-16by9 about2-video mb-4">
						<iframe title="Puente de Estrellas" frameBorder="0" className='embed-responsive-item' width="100%" height="400"
							srcDoc="<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black}</style><a href=https://www.youtube.com/embed/WtVDcvX0o3o/?autoplay=1><img src=https://img.youtube.com/vi/WtVDcvX0o3o/hqdefault.jpg alt='Video The Dark Knight Rises: What Went Wrong? Wisecrack Edition'><span>▶</span></a>"							
